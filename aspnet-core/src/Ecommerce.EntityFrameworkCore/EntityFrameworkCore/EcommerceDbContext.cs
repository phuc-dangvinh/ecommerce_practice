...
using Ecommerce.Manufactures;
using Ecommerce.Oders;
    ...
    ITenantManagementDbContext
{
    ...
    public DbSet<PromotionManufacture> PromotionManufactures { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new PromotionManufactureConfiguration());
